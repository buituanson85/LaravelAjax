                                ...
                                @auth
                                    @if(Auth::user()->utype === 'ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                ...
                                                <li class="menu-item" >
                                                    <a title="Dashboard" href="{{ route('category.allcategoryproduct') }}">Category</a>
                                                </li>
                                                <li class="menu-item" >
                                                    <a title="Dashboard" href="{{ route('product.allproduct') }}">Product</a>
                                                </li>
                                                <li class="menu-item">
                                    ...
                                    @else
                                        <li class="menu-item menu-item-has-children parent" >
                                            ...
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                    <a title="Dashboard" href="{{ route('users.dashboard') }}">User Dashboard</a>
                                                </li>
                                                <li class="menu-item">
                                                    <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                                                </li>
